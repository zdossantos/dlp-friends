...
<template>
    <Link
        ...
        :data-event-card-link="`event-card-link-${event.id}`"
    ...
    >
        <Card
            ...
            class="h-full overflow-hidden transition-[border-color,box-shadow,transform] group-hover:-translate-y-0.5 group-hover:border-primary/40 group-hover:shadow-md"
        ...
        >
            ...
            <CardFooter
                class="justify-end gap-1 text-sm font-medium text-primary"
            >
                {{ t('events.actions.open_details') }}
                <ChevronRight
