...
| Connexion Google et Apple | Implémenté | migration et modèle `social_accounts`, routes/actions Socialite, complétion de majorité et tests `SocialAuthenticationTest.php`/`WelcomeAndRegistrationTest.php` |
