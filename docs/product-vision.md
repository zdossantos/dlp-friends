...
Le site doit etre penser en mobile first.

L'application est indépendante et non affiliée à Disney ou Disneyland Paris.

## Public et principes

- Accès strictement réservé aux personnes de 18 ans ou plus.
- L'âge sert à vérifier la majorité et est visible dans le profil ; il ne sert pas à filtrer ou classer les suggestions.
- Aucune mécanique de rencontre amoureuse : le swipe est une interaction de découverte, pas un produit de dating.
- La vie privée prime : ville/région non demandée, photo personnelle non obligatoire, contrôle du profil et suppression disponibles dès la V1.
