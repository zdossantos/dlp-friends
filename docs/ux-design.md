...
4. Tutoriel produit linéaire : passer la première carte, liker la deuxième, ouvrir le match fictif puis répondre dans la conversation de démonstration. Une action incorrecte affiche l’instruction attendue sans avancer.
...
Le tutoriel masque la navigation membre principale et inférieure afin de garder un parcours guidé. Il reste utilisable au clavier, peut être quitté ou repris à l’étape enregistrée, et précise que ses profils, match et messages sont fictifs.
