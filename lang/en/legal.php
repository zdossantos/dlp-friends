...
return [
    ...
    'privacy' => [
        ...
        'title' => 'Privacy Policy', 'date_label' => 'Last updated:', 'date' => '1 September 2026', 'toc_label' => 'Contents', 'contact_missing' => 'Contact address to configure', 'footer' => 'DLP Friends protects only the data needed to provide the service.',
        'sections' => [
            ...
            ['id' => 'recipients', 'title' => '4. Recipients and hosting', 'paragraphs' => ['Data is available only to authorised people and necessary providers. The VPS is hosted by IONOS. MySQL, Redis, Reverb, and S3-compatible storage are self-hosted there. Mailpit is local-development only; the production SMTP provider will be selected and this page updated before activation. No advertising, payment, analytics, or OAuth service is currently enabled.'], 'items' => []],
            ...
            ['id' => 'security', 'title' => '6. Security and transfers', 'paragraphs' => ['We use access controls, encrypted connections, password hashing, and encrypted backups. No transfer outside the European Economic Area is planned; any change will be safeguarded and documented.'], 'items' => []],
            ['id' => 'cookies', 'title' => '7. Cookies', 'paragraphs' => ['Only storage strictly necessary for sessions, security, language, and interface preferences is used. No advertising or analytics cookie is enabled.'], 'items' => []],
